document.addEventListener('DOMContentLoaded', () => {
    ...
    if (reviewForm) {
        reviewForm.addEventListener('submit', function (e) {
            e.preventDefault();
            formMessage.textContent = "Sending review...";

            // Replace these with your actual Service ID and Template ID
            const serviceID = 'service_ffc0yoh';
            const templateID = 'template_kkjjowk';
            ...
            emailjs.sendForm(serviceID, templateID, this)
                .then(() => {
                    ...
                    formMessage.textContent = "Something went wrong! Check console.";
